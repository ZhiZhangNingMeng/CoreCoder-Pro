...
原生架构采用命令行形式，对话记录与上下文的浏览较为不便，且 Agent 的思考过程与工具调用记录会占据大量对话框空间，翻阅查找困难。本项目基于 Streamlit 构建 Web 交互前端，实现了流式输出效果，增加了工具调用的动态显示与可视化折叠面板，并支持保存会话、查看已保存对话以及清空历史记录，显著提升用户体验。
<img width="8816" height="4052" alt="主页面优化" src="https://github.com/user-attachments/assets/50e47d45-320f-4003-9ab8-5d7a6a84438b" />
