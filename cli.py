...
def _show_help():
    console.print(Panel(
        ...
        "  /ingest <file> Ingest local text/code into the knowledge base\n"
        "  quit           Exit CoreCoder\n"
        "\n"
        "[bold]Input:[/bold]\n"
